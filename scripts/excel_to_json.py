...
def main():
    ...
    # In a real scenario, you would have multiple files in the input directory.
    # For this example, we'll just take the first file we find.
    ...
    converted_data = convert_file(input_file, "excel-to-json")
